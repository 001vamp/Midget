export default function MusicCard() {
    ...
    return (<div id="card">
        {/* card */}
        <div className="bg-slate-900/75 w-48 h-60 rounded-xl shadow-lg backdrop-blur-xs flex flex-col items-center">
          ...
          <div className="flex flex-col ">
            ...
            <div className="flex flex-col items-center pr-25">
                <div className="text-white text-md font-semibold">use me</div>
                <div className="text-gray-400 text-xs font-light">skaiwater</div>
            </div>
